...
- [ファクトリを使う](using-factories/summary.md)
...
- [系列](sequences/summary.md)
  ...
  - [ファクトリ系列](sequences/factory-sequences.md)
  - [初期値](sequences/initial-value.md)
  - [ブロック無し](sequences/without-a-block.md)
  - [別称](sequences/aliases.md)
  - [系列URI](sequences/sequence-uris.md)
  - [巻き戻し](sequences/rewinding.md)
  - [値の設定](sequences/setting-the-value.md)
  - [系列の生成](sequences/generating.md)
